        ...
        <ul className="flex flex-col gap-4 lg:flex-row lg:justify-between lg:items-center">
          {pricePlans.plans.map((plan) => (
            ...
            >
              ...
              <Link
                href="/contact"
                className="flex justify-center items-center gap-2 bg-yellow-700 text-white px-4 py-2 rounded-lg cursor-pointer hover:bg-yellow-600 transition-all group font-semibold"
              >
                <span>ORDER NOW</span>
